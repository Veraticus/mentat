...
func (m *mockCommandRunnerAuth) RunCommandContext(ctx context.Context, name string, args ...string) (string, error) {
...
func TestWorkerAuthenticationErrorResponse(t *testing.T) {
